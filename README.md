...
- scenario: you get handed over a project you now need to maintain
- show the project
- eslint config
...
- there are other tools for some of these tasks that you might have used already (e.g. `depcheck`), but:
  - knip is all-in-one tool
  - knip "understands" the javascript ecosystem (we will see later what this means exactly)
- https://knip.dev/overview/getting-started
